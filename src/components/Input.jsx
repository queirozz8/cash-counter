...
export default function Input({ setBills, billValue, billName, inputBill, calculateValue }) {
  ...
  return (
    <div className="flex justify-center items-center gap-2 md:gap-3 w-72 md:w-96">
      <label className="flex justify-center items-center md:text-xl text-zinc-300" htmlFor={inputBill}>R$ {inputBill.replace('.', ',')}</label>
        <input
          className="p-2 md:p-4 text-zinc-300 bg-[#1D2623] border border-[#354942] rounded-xl placeholder:text-zinc-600"
          type="text"
